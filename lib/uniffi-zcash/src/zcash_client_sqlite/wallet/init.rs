...
impl From<WalletMigrationError> for ZcashWalletMigrationError {
    fn from(e: WalletMigrationError) -> Self {
        match e {
        	...
        	WalletMigrationError::CorruptedData(v) => ZcashWalletMigrationError::CorruptedData{ v },
        	WalletMigrationError::DbError{ .. } => ZcashWalletMigrationError::DbError{ v: "DbError".to_string() },
        	WalletMigrationError::BalanceError{ .. } => ZcashWalletMigrationError::BalanceError{ v: "BalanceError".to_string() },
        }
    }
}
