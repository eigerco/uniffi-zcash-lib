...
class Test(unittest.TestCase):
    def test_spending_key_conversions(self):
        ...
        expected_key_bytes = zts.get_as_u8_array("extended_spending_key")
    ...
    def test_spending_key_from_path(self):
        ...
        expected_derived_key_bytes = zts.get_as_u8_array("extended_spending_key_from_path")
    ...
    def test_spending_key_derive_child(self):
        ...
        expected_derived_key_bytes = zts.get_as_u8_array("extended_spending_key_derived_child")
    ...
    def test_spending_key_default_address(self):
        ...
        expected_address_bytes = zts.get_as_u8_array("extended_spending_key_default_address")

        self.assertEqual(result.address.to_bytes(), expected_address_bytes)

        expected_index_bytes = zts.get_as_u8_array("extended_spending_key_child_index")
    ...
    def test_spending_key_derive_internal(self):
        ...
        expected_derived_key_bytes = zts.get_as_u8_array("extended_spending_key_internal_sk")
    ...
    def test_spending_key_to_divers_fvk(self):
        ...
        expected_fvk_bytes = zts.get_as_u8_array("diversifiable_fvk")
