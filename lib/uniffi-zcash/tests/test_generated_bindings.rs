uniffi::build_foreign_language_testcases!(
    ...
    "tests/kotlin/orchard/keys/keys_outgoing_viewing_key.kts",
    "tests/kotlin/orchard/keys/keys_diversifier.kts",
    "tests/kotlin/orchard/keys/incoming_viewing_key.kts",
    "tests/kotlin/orchard/keys/spending_key.kts",
    "tests/kotlin/orchard/keys/keys_full_viewing_key.kts",
